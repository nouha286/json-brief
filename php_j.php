                    ...
                    <nav class="navbar navbar-light bg-light">
                        <div class="container-fluid">
                          ...
                          <form class="d-flex">
                            ...
                            <a class="rounded btn btn-primary btn-lg " style="border: none;color: white;  background-color:#00C1FE;class=" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">ADD NEW Students</a>
                          </form>
                        </div>
                      </nav>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
                    <form method="POST" action="./add-students.php">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="Date_of_admission" class="form-control" id="D">
                        </div>
               ...
               <div class="row px-4 bg-light" style="">
                    <hr style="color: gray; width: 100%;">
                     <div style="overflow-x:auto;">
                       ...
                       $tableaux=file_get_contents('z.json');
                       $tableau = json_decode($tableaux, true);
